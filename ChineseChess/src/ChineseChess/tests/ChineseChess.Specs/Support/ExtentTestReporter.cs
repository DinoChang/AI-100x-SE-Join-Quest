...
public class ExtentTestReporter
{
    ...
    private static ExtentReports CreateReporter()
    {
        ...
        var reportPath = Path.Combine(Directory.GetCurrentDirectory(), "TestResults", $"ChineseChess_ExtentReport_{timestamp}.html");
        ...
        _sparkReporter.Config.DocumentTitle = "ChineseChess BDD Test Report";
        _sparkReporter.Config.ReportName = "ChineseChess SpecFlow ExtentReports";
        ...
        // 設定系統資訊
        extent.AddSystemInfo("Project", "ChineseChess");
