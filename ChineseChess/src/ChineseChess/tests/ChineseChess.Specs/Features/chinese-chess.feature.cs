...
namespace ChineseChess.Specs.Features
{
    ...
    public partial class ChineseChess象棋RulesFeature : object, Xunit.IClassFixture<ChineseChess象棋RulesFeature.FixtureData>, System.IDisposable
    {
...
#line 1 "chinese-chess.feature"
#line hidden
        
        public ChineseChess象棋RulesFeature(ChineseChess象棋RulesFeature.FixtureData fixtureData, ChineseChess_Specs_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
  ...
  Each scenario sets up minimal conditions with relevant pieces.", ProgrammingLanguage.CSharp, featureTags);
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Red moves the General within the palace (Legal)")]
        [Xunit.TraitAttribute("FeatureTitle", "Chinese Chess (象棋) Rules")]
        [Xunit.TraitAttribute("Description", "Red moves the General within the palace (Legal)")]
        [Xunit.TraitAttribute("Category", "General")]
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Red moves the General outside the palace (Illegal)")]
        [Xunit.TraitAttribute("FeatureTitle", "Chinese Chess (象棋) Rules")]
        [Xunit.TraitAttribute("Description", "Red moves the General outside the palace (Illegal)")]
        [Xunit.TraitAttribute("Category", "General")]
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Generals face each other on the same file (Illegal)")]
        [Xunit.TraitAttribute("FeatureTitle", "Chinese Chess (象棋) Rules")]
        [Xunit.TraitAttribute("Description", "Generals face each other on the same file (Illegal)")]
        [Xunit.TraitAttribute("Category", "General")]
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Red moves the Guard diagonally in the palace (Legal)")]
        [Xunit.TraitAttribute("FeatureTitle", "Chinese Chess (象棋) Rules")]
        [Xunit.TraitAttribute("Description", "Red moves the Guard diagonally in the palace (Legal)")]
        [Xunit.TraitAttribute("Category", "Guard")]
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Red moves the Guard straight (Illegal)")]
        [Xunit.TraitAttribute("FeatureTitle", "Chinese Chess (象棋) Rules")]
        [Xunit.TraitAttribute("Description", "Red moves the Guard straight (Illegal)")]
        [Xunit.TraitAttribute("Category", "Guard")]
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Red moves the Rook along a clear rank (Legal)")]
        [Xunit.TraitAttribute("FeatureTitle", "Chinese Chess (象棋) Rules")]
        [Xunit.TraitAttribute("Description", "Red moves the Rook along a clear rank (Legal)")]
        [Xunit.TraitAttribute("Category", "Rook")]
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Red moves the Rook and attempts to jump over a piece (Illegal)")]
        [Xunit.TraitAttribute("FeatureTitle", "Chinese Chess (象棋) Rules")]
        [Xunit.TraitAttribute("Description", "Red moves the Rook and attempts to jump over a piece (Illegal)")]
        [Xunit.TraitAttribute("Category", "Rook")]
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Red moves the Horse in an \"L\" shape with no block (Legal)")]
        [Xunit.TraitAttribute("FeatureTitle", "Chinese Chess (象棋) Rules")]
        [Xunit.TraitAttribute("Description", "Red moves the Horse in an \"L\" shape with no block (Legal)")]
        [Xunit.TraitAttribute("Category", "Horse")]
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Red moves the Horse and it is blocked by an adjacent piece (Illegal)")]
        [Xunit.TraitAttribute("FeatureTitle", "Chinese Chess (象棋) Rules")]
        [Xunit.TraitAttribute("Description", "Red moves the Horse and it is blocked by an adjacent piece (Illegal)")]
        [Xunit.TraitAttribute("Category", "Horse")]
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Red moves the Cannon like a Rook with an empty path (Legal)")]
        [Xunit.TraitAttribute("FeatureTitle", "Chinese Chess (象棋) Rules")]
        [Xunit.TraitAttribute("Description", "Red moves the Cannon like a Rook with an empty path (Legal)")]
        [Xunit.TraitAttribute("Category", "Cannon")]
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Red moves the Cannon and jumps exactly one screen to capture (Legal)")]
        [Xunit.TraitAttribute("FeatureTitle", "Chinese Chess (象棋) Rules")]
        [Xunit.TraitAttribute("Description", "Red moves the Cannon and jumps exactly one screen to capture (Legal)")]
        [Xunit.TraitAttribute("Category", "Cannon")]
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Red moves the Cannon and tries to jump with zero screens (Illegal)")]
        [Xunit.TraitAttribute("FeatureTitle", "Chinese Chess (象棋) Rules")]
        [Xunit.TraitAttribute("Description", "Red moves the Cannon and tries to jump with zero screens (Illegal)")]
        [Xunit.TraitAttribute("Category", "Cannon")]
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Red moves the Cannon and tries to jump with more than one screen (Illegal)")]
        [Xunit.TraitAttribute("FeatureTitle", "Chinese Chess (象棋) Rules")]
        [Xunit.TraitAttribute("Description", "Red moves the Cannon and tries to jump with more than one screen (Illegal)")]
        [Xunit.TraitAttribute("Category", "Cannon")]
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Red moves the Elephant 2-step diagonal with a clear midpoint (Legal)")]
        [Xunit.TraitAttribute("FeatureTitle", "Chinese Chess (象棋) Rules")]
        [Xunit.TraitAttribute("Description", "Red moves the Elephant 2-step diagonal with a clear midpoint (Legal)")]
        [Xunit.TraitAttribute("Category", "Elephant")]
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Red moves the Elephant and tries to cross the river (Illegal)")]
        [Xunit.TraitAttribute("FeatureTitle", "Chinese Chess (象棋) Rules")]
        [Xunit.TraitAttribute("Description", "Red moves the Elephant and tries to cross the river (Illegal)")]
        [Xunit.TraitAttribute("Category", "Elephant")]
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Red moves the Elephant and its midpoint is blocked (Illegal)")]
        [Xunit.TraitAttribute("FeatureTitle", "Chinese Chess (象棋) Rules")]
        [Xunit.TraitAttribute("Description", "Red moves the Elephant and its midpoint is blocked (Illegal)")]
        [Xunit.TraitAttribute("Category", "Elephant")]
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Red moves the Soldier forward before crossing the river (Legal)")]
        [Xunit.TraitAttribute("FeatureTitle", "Chinese Chess (象棋) Rules")]
        [Xunit.TraitAttribute("Description", "Red moves the Soldier forward before crossing the river (Legal)")]
        [Xunit.TraitAttribute("Category", "Soldier")]
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Red moves the Soldier and tries to move sideways before crossing (Illegal)")]
        [Xunit.TraitAttribute("FeatureTitle", "Chinese Chess (象棋) Rules")]
        [Xunit.TraitAttribute("Description", "Red moves the Soldier and tries to move sideways before crossing (Illegal)")]
        [Xunit.TraitAttribute("Category", "Soldier")]
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Red moves the Soldier sideways after crossing the river (Legal)")]
        [Xunit.TraitAttribute("FeatureTitle", "Chinese Chess (象棋) Rules")]
        [Xunit.TraitAttribute("Description", "Red moves the Soldier sideways after crossing the river (Legal)")]
        [Xunit.TraitAttribute("Category", "Soldier")]
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Red moves the Soldier and attempts to move backward after crossing (Illegal)")]
        [Xunit.TraitAttribute("FeatureTitle", "Chinese Chess (象棋) Rules")]
        [Xunit.TraitAttribute("Description", "Red moves the Soldier and attempts to move backward after crossing (Illegal)")]
        [Xunit.TraitAttribute("Category", "Soldier")]
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Red captures opponent\'s General and wins immediately (Legal)")]
        [Xunit.TraitAttribute("FeatureTitle", "Chinese Chess (象棋) Rules")]
        [Xunit.TraitAttribute("Description", "Red captures opponent\'s General and wins immediately (Legal)")]
        [Xunit.TraitAttribute("Category", "Winning")]
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Red captures a non-General piece and the game continues (Legal)")]
        [Xunit.TraitAttribute("FeatureTitle", "Chinese Chess (象棋) Rules")]
        [Xunit.TraitAttribute("Description", "Red captures a non-General piece and the game continues (Legal)")]
        [Xunit.TraitAttribute("Category", "Winning")]
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                ChineseChess象棋RulesFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                ChineseChess象棋RulesFeature.FeatureTearDown();
            }
        }
    }
}
